...
func TestProposers(t *testing.T) {
	...
	/*
		...
		- Members setup the Voter resource in their account
		- Members of the DAO vote on the proposal
	...
	*/
	...
	color.Red("Should be able to check if an account holds 'Voter' resource")
	o.Script("DAO/checkIfVoter",
		WithArg("address", "alice")).Print()
	color.Green("Pass")
