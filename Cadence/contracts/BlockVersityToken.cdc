...
// Token contract of BlockVersity Token (BVT)
pub contract BlockVersityToken: FungibleToken {

    // Total supply of BVT tokens in existence
    ...
    init() {
        ...
        self.TokenStoragePath = /storage/blockVersityTokenVault
        self.TokenPublicReceiverPath = /public/blockVersityTokenReceiver
        self.TokenPublicBalancePath = /public/blockVersityTokenBalance
        self.TokenMinterStoragePath = /storage/blockVersityTokenMinter
        ...
        self.account.save(<-admin, to: /storage/blockVersityTokenAdmin)
